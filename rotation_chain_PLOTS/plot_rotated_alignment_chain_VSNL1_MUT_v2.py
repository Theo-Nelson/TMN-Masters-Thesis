...
output_plot_folder = "rotation_chain_plots_VSNL1_MUT_v2"
spatial_key = "spatial_cropped_150_buffer"

# Slices in order
slices = [
    "VSNL1_MUT_A1_heart_19",  # root
...
plt.title("VSNL1_MUT Hearts — After Full Cumulative Rotations", fontsize=28)
...
print("\n✅ Full hierarchical rotation and plotting complete for VSNL1_MUT!")
