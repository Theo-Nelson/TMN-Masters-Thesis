...
# === Config
input_folder = "VSNL1_COM_centered_alignment_cells"
...
print("🔄 Assigning cluster labels to VSNL1 individual objects...")
...
for fname in sorted(os.listdir(input_folder)):
    ...
    # Strip full prefix to recover original cell ID
    clean_index = [x.split("_", maxsplit=5)[-1] for x in ad.obs_names]

    # Assign cluster labels with fallback
    cluster_labels = []
    for cid in clean_index:
        if cid in combined_index:
...
print("\n✅ 3D views saved for VSNL1 clusters.")
