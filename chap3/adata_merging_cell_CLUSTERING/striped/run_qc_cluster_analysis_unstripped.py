...
# === New unified output directory for unstripped analysis
output_dir = "summary_plots/qc_filtered_unstripped"
os.makedirs(output_dir, exist_ok=True)

# === Load and merge .h5ad cell files
adata_list = []
for sample_id in samples:
    path = f"bin2cell_output_unstripped/{sample_id}/{sample_id}_cells.h5ad"
    adata = sc.read(path)
...
for sample_id in samples:
    ...
    plot_dir = os.path.join(f"bin2cell_output_unstripped/{sample_id}", "spatial_qc_filtered_clusters")
